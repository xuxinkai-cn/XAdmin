...
/**
 * File工具类，基于HuTool的FileTool工具类开发
 *
 * @author xuxinkai
 */
public class SysFileUtils extends FileUtil {

    private static final Logger log = LoggerFactory.getLogger(SysFileUtils.class);

    /**
     * 系统临时目录
     * windows 包含路径分割符，但Linux不包含,在windows \\==\ 前提下，为安全起见，统一拼装路径分割符
     * <pre>
     *       java.io.tmpdir
    ...
    /**
     * MultipartFile（前台传来的文件）转换成 File
